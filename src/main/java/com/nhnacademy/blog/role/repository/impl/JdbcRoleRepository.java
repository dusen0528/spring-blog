...
public class JdbcRoleRepository implements RoleRepository {
    ...
    public void save(Role role) {
        // TODO#2-4: 역할 정보를 데이터베이스에 저장하기 위한 SQL 쿼리 작성

    }

    @Override
    public void update(RoleUpdateRequestDto roleUpdateRequestDto) {
        // TODO#2-5: roleUpdateRequestDto 객체를 사용하여 업데이트할 SQL 쿼리 작성
    ...
    public void deleteByRoleId(String roleId) {
        // TODO#2-6: roleId를 사용하여 역할을 삭제하는 SQL 쿼리 작성
    ...
    public Optional<Role> findByRoleId(String roleId) {
        // TODO#2-7: roleId를 사용하여 역할을 조회하는 SQL 쿼리 작성
    ...
    public boolean existsByRoleId(String roleId) {
        // TODO#2-8: roleId로 역할이 존재하는지 확인하는 SQL 쿼리 작성
